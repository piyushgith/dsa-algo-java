...
##### This structured approach helps the AI understand exactly what you need and consider important aspects that you might forget to mention explicitly. Here's my go-to template for requesting code:
```

I need to implement [specific functionality] in Java/Python.
Key requirements:
1. [Requirement 1]
2. [Requirement 2]
3. [Requirement 3]
...
##### Never, ever blindly copy-paste AI-generated code into your project. Ask for an explanation first. Trust me. This will save you considerable debugging time and you will also learn a thing or two in the process. Here's a prompt I use for getting explanations:
